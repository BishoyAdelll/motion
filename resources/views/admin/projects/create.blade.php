            ...
            <div class="col-sm-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{route('projects.store')}}" method="post" class="needs-validation was-validated" novalidate="" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea name="subtitle" id="" cols="30" id="validationCustom01" class="form-control" rows="2" required="" data-bs-original-title="" title=""></textarea>
                                <div class="valid-feedback">{{__('lang.Looks good!')}}</div>
                                <div class="invalid-feedback">{{__('lang.Please fill out this field.')}}</div>
                            </div>
                            <div class="col-md-12 mb-3">
                                <label for="validationCustom01">{{__('lang.Content')}}</label>
                                <textarea name="content" id="" cols="30" id="validationCustom01" class="form-control" rows="5" data-bs-original-title="" title=""></textarea>
                                <div class="valid-feedback">{{__('lang.Looks good!')}}</div>
{{--                                <div class="invalid-feedback">{{__('lang.Please fill out this field.')}}</div>--}}
                            </div>
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control" name="url" id="validationCustom01" type="url" placeholder="{{__('lang.Title')}}" data-bs-original-title="" title="">
                                    <div class="valid-feedback">{{__('lang.Looks good!')}}</div>
{{--                                    <div class="invalid-feedback">{{__('lang.Please fill out this field.')}}</div>--}}
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control" name="image" id="validationCustom01" type="file" data-bs-original-title="" title="" required="" >
                                    <div class="valid-feedback">{{__('lang.Looks good!')}}</div>
                                    <div class="invalid-feedback">{{__('lang.Please fill out this field.')}}</div>
                                </div>
                            </div>
