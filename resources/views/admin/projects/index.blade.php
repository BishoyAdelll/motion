                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <a href="{{ route('projects.create') }}" class="btn btn-primary mb-3 " type="submit" data-bs-original-title="" title="">{{__('lang.Create')}}</a>
                            ...
                            <table id="example" class="display" style="width:100%">
                                ...
                                @foreach($projects as $project)
                                    <tr>
                                        <td>{{ $project->id }}</td>
                                        <td>{{ $project->title }}</td>
                                        <td>{{ substr($project->subtitle,0,30) }}...</td>
                                        <td><img src="{{asset('front/assets/img/project/'. $project->image )}}" alt="" style="max-width: 100px"></td>
                                        <td>{{ substr($project->content,0,30) }}...</td>
                                        <td>{{ $project->url }}</td>
                                        <td>
