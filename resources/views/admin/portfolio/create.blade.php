            ...
            <div class="col-sm-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{route('blog.store')}}" method="post" class="needs-validation was-validated" novalidate="" enctype="multipart/form-data">
                            @csrf

                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="validationCustom01">{{__('lang.Author Name')}}</label>
                                    <input class="form-control" name="author" id="validationCustom01" type="text" placeholder="{{__('lang.Author Name')}}" required="" data-bs-original-title="" title="">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input class="form-control" name="subtitle" id="validationCustom01" type="text" placeholder="{{__('lang.Subtitle')}}" required="" data-bs-original-title="" title="">
                                <div class="valid-feedback">{{__('lang.Looks good!')}}</div>
                                <div class="invalid-feedback">{{__('lang.Please fill out this field.')}}</div>
                            </div>
                            <div class="col-md-12 mb-3">
                                <label for="validationCustom01">{{__('lang.Content')}}</label>
                                <textarea name="content" cols="30" id="validationCustom01" class="form-control" rows="5" required="" data-bs-original-title="" title=""></textarea>
                                <div class="valid-feedback">{{__('lang.Looks good!')}}</div>
                                <div class="invalid-feedback">{{__('lang.Please fill out this field.')}}</div>
                            </div>
