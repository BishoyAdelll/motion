...
{{--                <div class="lang {{ (App::getLocale()  == 'ar') ? 'selected' : ''}}" data-value="ar"><i class="flag-icon flag-icon-eg"></i> <span class="lang-txt">لعربية</span> <span> (Ar)</span></div>--}}
{{--              </a>--}}
...
{{--        </li>--}}
        ...
        <li class="profile-nav onhover-dropdown p-0 me-0">
          <div class="media profile-media">
            ...
            <div class="media-body">
              <span>{{(Auth()->user() ? Auth()->user()->name : Auth::guard('employee')->user()->name) }}</span>
              <p class="mb-0 font-roboto">{{(Auth()->user() ? Auth()->user()->email : Auth::guard('employee')->user()->email) }} <i class="middle fa fa-angle-down"></i></p>
            </div>
          </div>
          <ul class="profile-dropdown onhover-show-div" style="padding: 10px;margin-top:-15px">
